...
<link href="/page/statics/dwz/themes/css/login.css" rel="stylesheet" type="text/css" />
<script src="/page/statics/dwz/js/jquery-1.7.2.min.js" type="text/javascript"></script>
<style type="text/css">
	...
	<div id="login">
		<div id="login_header">
			<h1 class="login_logo">
				...
				<a style="font-size:25px">卓玛管理后台</a>
			</h1>
		...
		<div id="login_content">
			<div class="loginForm">
				<form action="/mlm/dologin/json" method="post">
					<p>
						<label>用户名：</label>
			...
			<div class="login_banner"><img src="/page/statics/dwz/themes/default/images/login_banner.jpg" /></div>
