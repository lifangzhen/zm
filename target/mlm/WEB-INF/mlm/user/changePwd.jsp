...
<div class="pageContent">
	<form id="form" method="post" action="/mlm/changePwd/json" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="60">
			...
			<input type="hidden" name="forwardUrl" value="">
				...
				<div class="unit">
					<label></label>
					<span style="color:red;">提示：再次登录时需要使用新的密码！</span>
				</div>
		</div>
		<div class="formBar">
			<ul>
