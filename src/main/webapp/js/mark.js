...
$(function(){
	imgReload();
    var unslider06 = $('#b06').unslider({//轮播图插件
		dots: true,
		fluid: true,
	}),
	...
	$(".type").click(function(){//点击最新或者最热

		$(".type").removeClass("active");
		$(this).addClass("active");

		// 点击 最新或者最热  清空数据 重新获取 留言
		// $("#comsdiv .comitem").remove();
		// page = 1;
		// loadData();
	});
	$(document).on("click",".message",function(){//点击留言
...
function imgReload(){//根据手机尺寸生成轮播图大小
	var imgHeight = 0;
	var wtmp = $("body").width();
...
$(window).resize(function(){imgReload();});//页面尺寸调整
